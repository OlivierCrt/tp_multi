...
static const char *min_err_table[] = {"stub-gss: no error",
                                      "stub-gss: no memory",
...
OM_uint32 gss_init_sec_context(
    OM_uint32 *min, gss_const_cred_id_t initiator_cred_handle,
  ...
  *min = 0;
  ...
  /* Note: this is using the *real* snprintf() and not the curl provided
     one */
  used = snprintf(token, length, "%s:%s:%d:", creds, (char *)target_name,
                  ctx->sent);
...
OM_uint32 gss_delete_sec_context(OM_uint32 *min, gss_ctx_id_t *context_handle,
...
OM_uint32 gss_import_name(OM_uint32 *min, const gss_buffer_t input_name_buffer,
...
OM_uint32 gss_display_status(OM_uint32 *min, OM_uint32 status_value,
...
OM_uint32 gss_display_name(OM_uint32 *min, gss_const_name_t input_name,
...
OM_uint32 gss_inquire_context(OM_uint32 *min, gss_const_ctx_id_t context_handle,
                              gss_name_t *src_name, gss_name_t *targ_name,
                              OM_uint32 *lifetime_rec, gss_OID *mech_type,
                              OM_uint32 *ctx_flags, int *locally_initiated,
                              int *open_context) {
  (void)min;
  (void)context_handle;
  (void)src_name;
...
OM_uint32 gss_wrap(OM_uint32 *min, gss_const_ctx_id_t context_handle,
...
OM_uint32 gss_unwrap(OM_uint32 *min, gss_const_ctx_id_t context_handle,
...
OM_uint32 gss_seal(OM_uint32 *min, gss_ctx_id_t context_handle,
...
OM_uint32 gss_unseal(OM_uint32 *min, gss_ctx_id_t context_handle,

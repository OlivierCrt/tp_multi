...
static curl_socket_t tst_opensocket(void *clientp, curlsocktype purpose,
      ...
      if (moo) {
        ...
        if (time_namelookup > time_connect) {
          fprintf(moo,
                  ...
                  (long)(time_namelookup % 1000000), (time_connect / 1000000),
        ...
        if (time_starttransfer > time_total) {
          fprintf(moo,
                  ...
                  ".%06ld %" CURL_FORMAT_CURL_OFF_T ".%06ld\n",
                  (time_starttransfer / 1000000),
                  (long)(time_starttransfer % 1000000), (time_total / 1000000),

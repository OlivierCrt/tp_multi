...
rc = curl_formadd(&post, &last, CURLFORM_COPYNAME, "htmlcode",
                  CURLFORM_COPYCONTENTS, "<HTML></HTML>", CURLFORM_CONTENTTYPE,
...
rc = curl_formadd(&post, &last, CURLFORM_PTRNAME, "name of file field",
                  CURLFORM_FILE, arg, CURLFORM_FILENAME, "custom named file",
                  CURLFORM_END);

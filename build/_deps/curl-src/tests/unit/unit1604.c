...
UNITTEST_START { /* START sanitize_file_name */
  struct data data[] = {
      {"", 0, "", SANITIZE_ERR_OK},
      ...
      {"f:/foo", SANITIZE_ALLOW_PATH, "f:/foo", SANITIZE_ERR_OK},
#ifndef MSDOS
      {"\\\\?\\C:\\foo", SANITIZE_ALLOW_PATH, "\\\\?\\C:\\foo",
       SANITIZE_ERR_OK},
      ...
      {"f:\\com1", SANITIZE_ALLOW_RESERVED | SANITIZE_ALLOW_COLONS, "f:_com1",
       SANITIZE_ERR_OK},
      {"f:\\com1", SANITIZE_ALLOW_RESERVED | SANITIZE_ALLOW_PATH, "f:\\com1",
       SANITIZE_ERR_OK},
      ...
      {"\\\\?\\C:\\com1", SANITIZE_ALLOW_PATH, "\\\\?\\C:\\com1",
       SANITIZE_ERR_OK},
#endif
      {"CoM1", 0, "_CoM1", SANITIZE_ERR_OK},
      {"CoM1", SANITIZE_ALLOW_RESERVED, "CoM1", SANITIZE_ERR_OK},
  ...
  /* At the moment we expect a maximum path length of 259. I assume MSDOS
     ...
     so currently these "good" truncate tests won't run on MSDOS */
      ...
      {"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
       ...
       "EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE"
       "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF",
       0, NULL, SANITIZE_ERR_INVALID_PATH},
      {"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
       "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB"
       "CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC"
       "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD"
       ...
       SANITIZE_ALLOW_TRUNCATE, NULL, SANITIZE_ERR_INVALID_PATH},
      {"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
       "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB"
       "CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC"
       "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD"
       ...
       SANITIZE_ALLOW_TRUNCATE | SANITIZE_ALLOW_PATH, NULL,
  ...
  for (i = 0; i < sizeof(data) / sizeof(data[0]); ++i) {
    ...
    fprintf(stderr,
            ...
            "expected output: %s\n"
            "expected result: %s\n",
            __FILE__, __LINE__, data[i].input, flagstr,
            (output ? output : "(null)"), received_ccstr,

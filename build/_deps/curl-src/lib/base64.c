...
#include "curl_setup.h"
    ...
    !defined(CURL_DISABLE_LDAP) || !defined(CURL_DISABLE_SMTP) ||              \
    !defined(CURL_DISABLE_POP3) || !defined(CURL_DISABLE_IMAP) ||              \
 ...
 * @unittest: 1302
 */
CURLcode Curl_base64_decode(const char *src, unsigned char **outptr,
                            size_t *outlen) {
  size_t srclen = 0;
  size_t padding = 0;
  size_t i;
...
static CURLcode base64_encode(const char *table64, const char *inputbuff,
                              size_t insize, char **outptr, size_t *outlen) {
  char *output;
  char *base64data;

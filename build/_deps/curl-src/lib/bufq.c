...
static size_t chunk_append(struct buf_chunk *chunk, const unsigned char *buf,
                           size_t len) {
...
static size_t chunk_read(struct buf_chunk *chunk, unsigned char *buf,
                         size_t len) {
...
static CURLcode bufcp_take(struct bufc_pool *pool, struct buf_chunk **pchunk) {
...
static void bufcp_put(struct bufc_pool *pool, struct buf_chunk *chunk) {
...
static void bufq_init(struct bufq *q, struct bufc_pool *pool, size_t chunk_size,
...
bool Curl_bufq_peek(struct bufq *q, const unsigned char **pbuf, size_t *plen) {
...
ssize_t Curl_bufq_write_pass(struct bufq *q, const unsigned char *buf,
                             size_t len, Curl_bufq_writer *writer,
                             void *writer_ctx, CURLcode *err) {
...
ssize_t Curl_bufq_sipn(struct bufq *q, size_t max_len, Curl_bufq_reader *reader,

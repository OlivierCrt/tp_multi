...
#define SSLSUPP_TLS13_CIPHERSUITES                                             \
  (1 << 5) /* supports TLS 1.3 ciphersuites                                    \
            */
...
#define VTLS_INFOF_ALPN_OFFER_1STR "ALPN: curl offers %s"
#define VTLS_INFOF_ALPN_ACCEPTED_1STR ALPN_ACCEPTED "%s"
#define VTLS_INFOF_ALPN_ACCEPTED_LEN_1STR ALPN_ACCEPTED "%.*s"

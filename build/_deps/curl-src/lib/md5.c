...
static void my_md5_update(my_md5_ctx *ctx, const unsigned char *input,
...
static void my_md5_update(my_md5_ctx *ctx, const unsigned char *data,
                          unsigned int length) {
...
CURLcode Curl_MD5_update(struct MD5_context *context, const unsigned char *data,
                         unsigned int len) {

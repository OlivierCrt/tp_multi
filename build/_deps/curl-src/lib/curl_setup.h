...
#if !(defined(__NEWLIB__) || (defined(__CLIB2__) && defined(__THREAD_SAFE)))
...
#if defined(USE_OPENSSL) || defined(USE_MBEDTLS) || defined(USE_GNUTLS) ||     \
...
#if defined(SOCKET) || defined(USE_WINSOCK) || defined(HAVE_WINSOCK2_H) ||     \

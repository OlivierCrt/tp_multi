...
static CURLcode setstropt_userpwd(char *option, char **userp, char **passwdp) {
  ...
  if (option) {
    ...
    result = Curl_parse_login_details(option, len, (userp ? &user : NULL),
                                      (passwdp ? &passwd : NULL), NULL);
  }
...
CURLcode Curl_vsetopt(struct Curl_easy *data, CURLoption option,
  ...
  case CURLOPT_KEEP_SENDING_ON_ERROR:
    data->set.http_keep_sending_on_error =
  ...
  case CURLOPT_REQUEST_TARGET:
    result =
        Curl_setstropt(&data->set.str[STRING_TARGET], va_arg(param, char *));
    break;
...
#ifdef USE_SSL
  {
    ...
    if (version < CURL_SSLVERSION_DEFAULT || version == CURL_SSLVERSION_SSLv2 ||
        version == CURL_SSLVERSION_SSLv3 || version >= CURL_SSLVERSION_LAST ||
  ...
  case CURLOPT_COPYPOSTFIELDS:
    ...
    if (!argptr || data->set.postfieldsize == -1)
      ...
      if ((data->set.postfieldsize < 0) ||
        ...
        */
        p = malloc(
            (size_t)(data->set.postfieldsize ? data->set.postfieldsize : 1));
  ...
  case CURLOPT_AWS_SIGV4:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_AWS_SIGV4], va_arg(param, char *));
    /*
  ...
  case CURLOPT_USERAGENT:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_USERAGENT], va_arg(param, char *));
    break;
  ...
  case CURLOPT_COOKIE:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_COOKIE], va_arg(param, char *));
    break;
  ...
  case CURLOPT_PROXY:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_PROXY], va_arg(param, char *));
    break;
  ...
  case CURLOPT_PRE_PROXY:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_PRE_PROXY], va_arg(param, char *));
    break;
  ...
  case CURLOPT_FTPPORT:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_FTPPORT], va_arg(param, char *));
  ...
  case CURLOPT_KRBLEVEL:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_KRB_LEVEL], va_arg(param, char *));
  ...
  case CURLOPT_URL:
    ...
    result =
        Curl_setstropt(&data->set.str[STRING_SET_URL], va_arg(param, char *));
  ...
  case CURLOPT_USERNAME:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_USERNAME], va_arg(param, char *));
    break;
  case CURLOPT_PASSWORD:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_PASSWORD], va_arg(param, char *));
    break;
  ...
  case CURLOPT_LOGIN_OPTIONS:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_OPTIONS], va_arg(param, char *));
    break;
  ...
  case CURLOPT_XOAUTH2_BEARER:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_BEARER], va_arg(param, char *));
    break;
  ...
  case CURLOPT_NOPROXY:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_NOPROXY], va_arg(param, char *));
    break;
#endif
  ...
  case CURLOPT_RANGE:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_SET_RANGE], va_arg(param, char *));
    break;
  ...
  case CURLOPT_SSLCERT:
     ...
     */
    result = Curl_setstropt(&data->set.str[STRING_CERT], va_arg(param, char *));
    break;
  ...
  case CURLOPT_SSLCERTTYPE:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_CERT_TYPE], va_arg(param, char *));
    break;
#ifndef CURL_DISABLE_PROXY
  ...
  case CURLOPT_SSLKEY:
     ...
     */
    result = Curl_setstropt(&data->set.str[STRING_KEY], va_arg(param, char *));
    break;
  ...
  case CURLOPT_PROXY_SSLKEY:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_KEY_PROXY], va_arg(param, char *));
    break;
  ...
  case CURLOPT_SSLKEYTYPE:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_KEY_TYPE], va_arg(param, char *));
    break;
#ifndef CURL_DISABLE_PROXY
  ...
  case CURLOPT_INTERFACE:
     ...
     */
    result =
        Curl_setstropt(&data->set.str[STRING_DEVICE], va_arg(param, char *));
    break;
  ...
  case CURLOPT_DOH_SSL_VERIFYPEER:
     ...
     */
    data->set.doh_verifypeer = (0 != va_arg(param, long)) ? TRUE : FALSE;
    break;
#endif
#ifndef CURL_DISABLE_PROXY
  ...
  case CURLOPT_DOH_SSL_VERIFYSTATUS:
    ...
    data->set.doh_verifystatus = (0 != va_arg(param, long)) ? TRUE : FALSE;
    break;
#endif
  ...
  case CURLOPT_MAIL_FROM:
    ...
    result =
        Curl_setstropt(&data->set.str[STRING_MAIL_FROM], va_arg(param, char *));
    break;

  case CURLOPT_MAIL_AUTH:
    /* Set the SMTP auth originator */
    result =
        Curl_setstropt(&data->set.str[STRING_MAIL_AUTH], va_arg(param, char *));
    break;

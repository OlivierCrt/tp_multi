...
static void my_sha256_update(my_sha256_ctx *ctx, const unsigned char *data,
                             unsigned int length) {
...
*/
static int my_sha256_update(struct sha256_state *md, const unsigned char *in,
                            unsigned long inlen) {
  unsigned long n;
...
/*
   ...
   @return 0 if successful
*/
static int my_sha256_final(unsigned char *out, struct sha256_state *md) {
  int i;

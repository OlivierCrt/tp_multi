...
int Curl_getaddrinfo_ex(const char *nodename, const char *servname,
...
struct Curl_addrinfo *Curl_ip2addr(int af, const void *inaddr,
...
struct Curl_addrinfo *Curl_unix2addr(const char *path, bool *longpath,
  ...
  *longpath = FALSE;
  ...
  ai->ai_addrlen =
      (curl_socklen_t)((offsetof(struct sockaddr_un, sun_path) + path_len) &
                       0x7FFFFFFF);

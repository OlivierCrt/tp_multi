...
struct curl_easyoption Curl_easyopts[] = {
    ...
    {"FTP_RESPONSE_TIMEOUT", CURLOPT_SERVER_RESPONSE_TIMEOUT, CURLOT_LONG,
     CURLOT_FLAG_ALIAS},
    ...
    {"MAIL_RCPT_ALLLOWFAILS", CURLOPT_MAIL_RCPT_ALLOWFAILS, CURLOT_LONG,
     CURLOT_FLAG_ALIAS},
    ...
    {"SERVER_RESPONSE_TIMEOUT", CURLOPT_SERVER_RESPONSE_TIMEOUT, CURLOT_LONG,
     0},

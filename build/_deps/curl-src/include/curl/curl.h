...
/* Compile-time deprecation macros. */
    ...
    !defined(__INTEL_COMPILER) && !defined(CURL_DISABLE_DEPRECATION) &&        \
    !defined(BUILDING_LIBCURL)
#define CURL_DEPRECATED(version, message)                                      \
  __attribute__((deprecated("since " #version ". " message)))
#define CURL_IGNORE_DEPRECATION(statements)                                    \
  _Pragma("GCC diagnostic push")                                               \
      _Pragma("GCC diagnostic ignored \"-Wdeprecated-declarations\"")          \
          statements _Pragma("GCC diagnostic pop")
#else
#define CURL_DEPRECATED(version, message)
...
typedef int (*curl_sshhostkeycallback)(
...
typedef enum {
  ...
  CURLOPTDEPRECATED(CURLOPT_HTTPPOST, CURLOPTTYPE_OBJECTPOINT, 24, 7.56.0,
  ...
  /* HTTP PUT */
  CURLOPTDEPRECATED(CURLOPT_PUT, CURLOPTTYPE_LONG, 54, 7.12.1,
                    "Use CURLOPT_UPLOAD"),
...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  CURLOPTDEPRECATED(CURLOPT_RANDOM_FILE, CURLOPTTYPE_STRINGPOINT, 76, 7.84.0,
                    "Serves no purpose anymore"),

  /* Set to the Entropy Gathering Daemon socket pathname */
  CURLOPTDEPRECATED(CURLOPT_EGDSOCKET, CURLOPTTYPE_STRINGPOINT, 77, 7.84.0,
                    "Serves no purpose anymore"),
  ...
  CURLOPTDEPRECATED(CURLOPT_DNS_USE_GLOBAL_CACHE, CURLOPTTYPE_LONG, 91, 7.11.1,
                    "Use CURLOPT_SHARE"),
  ...
  */
  ...
  CURLOPTDEPRECATED(CURLOPT_IOCTLDATA, CURLOPTTYPE_CBPOINT, 131, 7.18.0,
  ...
  */
  ...
  CURLOPTDEPRECATED(CURLOPT_CONV_FROM_NETWORK_FUNCTION,
                    CURLOPTTYPE_FUNCTIONPOINT, 142, 7.82.0,
                    "Serves no purpose anymore"),

  /* Function that will be called to convert to the
     network encoding (instead of using the iconv calls in libcurl) */
  CURLOPTDEPRECATED(CURLOPT_CONV_TO_NETWORK_FUNCTION, CURLOPTTYPE_FUNCTIONPOINT,
                    143, 7.82.0, "Serves no purpose anymore"),

  /* Function that will be called to convert from UTF8
     (instead of using the iconv calls in libcurl)
     Note that this is used only for SSL certificate processing */
  CURLOPTDEPRECATED(CURLOPT_CONV_FROM_UTF8_FUNCTION, CURLOPTTYPE_FUNCTIONPOINT,
                    144, 7.82.0, "Serves no purpose anymore"),
  ...
  /* Socks Service */
  /* DEPRECATED, do not use! */
  CURLOPTDEPRECATED(CURLOPT_SOCKS5_GSSAPI_SERVICE, CURLOPTTYPE_STRINGPOINT, 179,
  ...
  CURLOPTDEPRECATED(CURLOPT_PROTOCOLS, CURLOPTTYPE_LONG, 181, 7.85.0,
                    "Use CURLOPT_PROTOCOLS_STR"),

  /* set the bitmask for the protocols that libcurl is allowed to follow to,
     as a subset of the CURLOPT_PROTOCOLS ones. That means the protocol needs
     to be set in both bitmasks to be allowed to get redirected to. */
  CURLOPTDEPRECATED(CURLOPT_REDIR_PROTOCOLS, CURLOPTTYPE_LONG, 182, 7.85.0,
  ...
  */
  ...
  CURLOPTDEPRECATED(CURLOPT_SSL_ENABLE_NPN, CURLOPTTYPE_LONG, 225, 7.86.0,
                    "Has no function"),
...
#define CURLMIMEOPT_FORMESCAPE                                                 \
  (1 << 0) /* Use backslash-escaping for forms.                                \
            */
 ...
 */
CURL_EXTERN CURLcode curl_mime_data(curl_mimepart *part, const char *data,
                                    size_t datasize);
 ...
 */
CURL_EXTERN CURLcode curl_mime_data_cb(curl_mimepart *part, curl_off_t datasize,
 ...
 * error occurred.
 */
CURL_EXTERN char *curl_easy_escape(CURL *handle, const char *string,
                                   int length);
 ...
 */
CURL_EXTERN CURLcode curl_global_init_mem(long flags, curl_malloc_callback m,
...
typedef enum {
  ...
  CURLINFO_SIZE_DOWNLOAD CURL_DEPRECATED(
      7.55.0, "Use CURLINFO_SIZE_DOWNLOAD_T") = CURLINFO_DOUBLE + 8,
  CURLINFO_SIZE_DOWNLOAD_T = CURLINFO_OFF_T + 8,
  CURLINFO_SPEED_DOWNLOAD CURL_DEPRECATED(
      7.55.0, "Use CURLINFO_SPEED_DOWNLOAD_T") = CURLINFO_DOUBLE + 9,
  CURLINFO_SPEED_DOWNLOAD_T = CURLINFO_OFF_T + 9,
  CURLINFO_SPEED_UPLOAD CURL_DEPRECATED(7.55.0, "Use CURLINFO_SPEED_UPLOAD_T") =
      CURLINFO_DOUBLE + 10,
  ...
  CURLINFO_CONTENT_LENGTH_DOWNLOAD CURL_DEPRECATED(
      7.55.0, "Use CURLINFO_CONTENT_LENGTH_DOWNLOAD_T") = CURLINFO_DOUBLE + 15,
  CURLINFO_CONTENT_LENGTH_DOWNLOAD_T = CURLINFO_OFF_T + 15,
  CURLINFO_CONTENT_LENGTH_UPLOAD CURL_DEPRECATED(
      7.55.0, "Use CURLINFO_CONTENT_LENGTH_UPLOAD_T") = CURLINFO_DOUBLE + 16,

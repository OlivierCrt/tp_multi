...
*/
bool progress_meter(struct GlobalConfig *global, struct timeval *start,
                    bool final) {
  ...
  if (final || (diff > 500)) {
    ...
    fprintf(tool_stderr,
            ...
            dlpercen, /* 3 letters */
            ulpercen, /* 3 letters */
            max5data(all_dlnow, buffer[0]), max5data(all_ulnow, buffer[1]),
            all_xfers, all_running, time_total, time_spent, time_left,

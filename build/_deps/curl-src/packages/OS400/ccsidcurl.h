...
CURL_EXTERN char *curl_easy_escape_ccsid(CURL *handle, const char *string,
                                         int length, unsigned int sccsid,
                                         unsigned int dccsid);
...
CURL_EXTERN CURLcode curl_mime_name_ccsid(curl_mimepart *part, const char *name,
                                          unsigned int ccsid);
...
CURL_EXTERN CURLcode curl_mime_filedata_ccsid(curl_mimepart *part,
                                              const char *filename,
                                              unsigned int ccsid);
CURL_EXTERN CURLcode curl_mime_data_ccsid(curl_mimepart *part, const char *data,
...
CURL_EXTERN CURLcode curl_easy_setopt_RPGnum_(CURL *easy, CURLoption tag,
                                              curl_off_t arg);
